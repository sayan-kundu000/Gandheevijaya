...
# Read current build_ch18_part2.py
with open('scripts/build_ch18_part2.py', 'r', encoding='utf-8') as f:
    text = f.read()

# We will write a complete, self-contained Python script that defines shlokas_part2,
# validates that ALL 28 SHLOKAS HAVE EXACTLY 31 SENTENCES, and builds:
# 1. frontend/src/data/gita/bhagavad_gita_ch18_part2_28_shlokas.json
# 2. C:\Users\DELL\.gemini\antigravity-ide\brain\5c721c30-1a2b-422d-bec6-f35d52a3138c\chapter18_part2_moksha_sanyasa_yoga.md
...
# Apply additions before the last sentence of each item
for item in shlokas:
    num = item['number']
    if num in additions:
...
print("\nSUCCESS: All 28 Shlokas have EXACTLY 31 sentences!")
...
for item in shlokas:
    ...
    # Join the 31 sentences into one single large paragraph
